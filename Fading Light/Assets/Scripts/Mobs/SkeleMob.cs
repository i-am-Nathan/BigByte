// file:	Assets\Scripts\Mobs\SkeleMob.cs
//
// summary:	Implements the skele mob class
...
public class SkeleMob : BaseEntity
{
	...
	public enum States
	{
        ...
        Sleep,
        /// <summary>   An enum constant representing the revival option. </summary>
        Revival,
